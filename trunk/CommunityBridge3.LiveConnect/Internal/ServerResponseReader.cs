using CommunityBridge3.LiveConnect.Internal.Operations;
using CommunityBridge3.LiveConnect.Internal.Serialization;
using System;
using System.Collections.Generic;

namespace CommunityBridge3.LiveConnect.Internal
{
  /// <summary>
